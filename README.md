...
|--------|---------|-------------|
| **[`main`](https://github.com/yamcodes/contact.app/tree/main)** (You're here!) | **Web 1.0 via JSX** | **Hono JSX templating, full page reloads** |
| [`htmx`](https://github.com/yamcodes/contact.app/tree/htmx) | htmx | Partial updates, no full page reloads |
| [`eta`](https://github.com/yamcodes/contact.app/tree/eta) | Web 1.0 via Eta | Classic string-based templating |
